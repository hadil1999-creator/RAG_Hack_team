    ...
    <div className="flex w-full h-screen  justify-between">
        ...
        <div className="w-full h-full rounded-xl ">
          ...
          <div className="flex flex-col mt-16 ml-44 w-[26rem] ">
            <div className="">
              ...
              <h2 className="text-xl font-semibold mt-4">Get Started</h2>
              <p className="text-neutral-300">
                Welcome to FinAI - Let&apos;s create your account
              </p>
      ...
      <div className="w-[45%] transition-transform scale-95 p-12 rounded-2xl  bg-gradient-to-tr from-green-950 via-black to-green-950">
        <div className="text-[#f0fff1] text-5xl">
          ...
          <span className="flex flex-col ml-16 mt-5 font-serif text-[3.4rem]">of finance with  <span className="text-green-600">FinAI</span></span> <br />
        </div>
        <div className="flex justify-end"><img src={robom} alt="" className="w-96 h-96"/></div>
      </div>
    </div>
  );
}
